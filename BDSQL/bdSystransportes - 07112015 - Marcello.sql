...
REPLACE INTO `cargas` (`codCarga`, `codUsuario`, `origem`, `destino`, `altura`, `largura`, `peso`, `comprimento`, `quantidade`, `valor`, `telefone`, `logradouro`, `bairro`, `uf`, `cidade`, `numero`, `observacao`, `naturezaCarga`, `dataPedido`, `distancia`, `prazo`, `frete`, `coletada`, `cotado`, `statusCarga`) VALUES
	(9, 8, 2611606, 2606002, 2, 1, 30, 2, 32, 152, '1234567', 'rua dona elvira', 'encruzilhada', 'PE', 'recife', '280', 'chamar pela campainha', '', '03/11/2015', 230, '1 Dia(s)', 50, 'Coletado', 'Cotado', 'Aprovado'),
	(10, 8, 2611606, 2606002, 2, 1, 30, 2, 32, 152, '1234567', 'rua dona elvira', 'encruzilhada', 'PE', 'recife', '280', 'chamar pela campainha', '', '03/11/2015', 230, '1 Dia(s)', 50, 'Coletado', 'Cotado', 'Aprovado');
...
-- Copiando dados para a tabela systransportes.cidades: ~5.607 rows (aproximadamente)
/*!40000 ALTER TABLE `cidades` DISABLE KEYS */;
REPLACE INTO `cidades` (`codigo`, `descricao`, `uf`) VALUES
...
-- Copiando dados para a tabela systransportes.coleta: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `coleta` DISABLE KEYS */;
REPLACE INTO `coleta` (`codColeta`, `codCarga`, `codMotorista`, `codVeiculo`, `data`, `hora`) VALUES
	(5, 10, 4, 1, '04/11/2015', '22:00'),
	(6, 9, 4, 1, '03/11/2015', '23:00');
...
CREATE TABLE IF NOT EXISTS `ctes` (
  ...
  PRIMARY KEY (`numcte`),
  UNIQUE KEY `numcte` (`numcte`),
  KEY `FK_ctes_cargas` (`codCarga`),
  KEY `FK_ctes_frete` (`codFrete`),
  CONSTRAINT `FK_ctes_cargas` FOREIGN KEY (`codCarga`) REFERENCES `cargas` (`codCarga`),
  CONSTRAINT `FK_ctes_frete` FOREIGN KEY (`codFrete`) REFERENCES `frete` (`codFrete`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela systransportes.ctes: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `ctes` DISABLE KEYS */;
REPLACE INTO `ctes` (`numcte`, `codCarga`, `codFrete`, `situacao`, `chaveAcesso`, `statuscte`, `emissao`, `chave_gcm`) VALUES
	(179334, 9, 1, NULL, NULL, NULL, NULL, NULL),
	(199869, 9, 1, NULL, NULL, NULL, NULL, NULL),
	(363823, 9, 1, NULL, NULL, NULL, NULL, NULL),
	(374728, 9, 1, NULL, NULL, NULL, NULL, NULL),
	(380560, 9, 1, NULL, NULL, NULL, NULL, NULL),
	(413248, 9, 1, NULL, NULL, NULL, NULL, NULL),
	(459282, 9, 5, 'Despachada', '12345', 'Autorizado', '03/11/2015', ''),
	(498318, 9, 1, NULL, NULL, NULL, NULL, NULL),
	(528130, 9, 1, NULL, NULL, NULL, NULL, NULL),
	(644368, 9, 1, NULL, NULL, NULL, NULL, NULL),
	(652533, 9, 1, NULL, NULL, NULL, NULL, NULL),
	(906711, 9, 1, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `frete` (
  ...
  KEY `FK_frete_usuarios` (`codMotorista`),
  KEY `FK_frete_veiculos` (`codVeiculo`),
  CONSTRAINT `FK_frete_usuarios` FOREIGN KEY (`codMotorista`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `FK_frete_veiculos` FOREIGN KEY (`codVeiculo`) REFERENCES `veiculos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela systransportes.frete: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `frete` DISABLE KEYS */;
REPLACE INTO `frete` (`codFrete`, `codVeiculo`, `codMotorista`, `ufOrigem`, `cidadeOrigem`, `ufDestino`, `cidadeDestino`, `statusFrete`, `codTransp`) VALUES
	(1, 1, 2, 'PE', 'Recife', 'PE', 'Recife', '', '123456'),
	(5, 1, 6, 'PE', 'recife', 'PE', 'garanhuns', 'Iniciada', '919514');
...
-- Copiando dados para a tabela systransportes.mercadorias: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `mercadorias` DISABLE KEYS */;
REPLACE INTO `mercadorias` (`id`, `codCarga`, `descricao`, `pesoMercadoria`, `valorMercadoria`, `quantidade`, `numPedido`) VALUES
	(15, 9, 'Refrigerante', '30', 150, 40, 0),
	(16, 10, 'caixotes', '2', 3, 2, 0);
...
CREATE TABLE IF NOT EXISTS `rastreamentos` (
  ...
  `codFrete` int(11) DEFAULT NULL,
  `localizacao` varchar(50) DEFAULT NULL,
  `longitude` float DEFAULT NULL,
  `latitude` float DEFAULT NULL,
  `data` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`codRastreamento`),
  KEY `FK_rastreamentos_frete` (`codFrete`),
  CONSTRAINT `FK_rastreamentos_frete` FOREIGN KEY (`codFrete`) REFERENCES `frete` (`codFrete`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Copiando dados para a tabela systransportes.usuarios: ~9 rows (aproximadamente)
...
REPLACE INTO `usuarios` (`id`, `perfil`, `status`, `razaoSocial`, `nomeFantasia`, `tipoEmpresa`, `cnpj`, `nomeCompleto`, `cpf`, `rg`, `orgaoExpedidor`, `email`, `telefone1`, `telefone2`, `logradouro`, `bairro`, `numero`, `complemento`, `cep`, `estado`, `cidade`, `login`, `senha`) VALUES
	(1, 'Atendente', 'Habilitado', NULL, NULL, NULL, NULL, 'ADMIN', '999.999.999-99', '999.999-9', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'master', '123'),
	(2, 'Motorista', 'Habilitado', '', '', '', '', 'MOTORISTA', '999.999.999-99', '999.999-9', '', '', '', '', '', '', '', '', '', '', '', 'motorista', '123'),
	(3, 'Motorista', 'Habilitado', '', '', '', '', 'Thiago', '999.999.999-99', '999.999-9', 'sds/pe', 'teste@gmail.com', '(81) 9999-9999', '(81) 9999-9999', 'Rua Dona Elvira', 'Encruzilhada', '999', '', '9999-999', 'PE', 'Recife', 'thiago', '123'),
	(4, 'Motorista', 'Habilitado', '', '', '', '', 'Josenaldo', '999.999.999-99', '999.999-9', 'sds/pe', 'teste@gmail.com', '(81) 9999-9999', '(81) 9999-9999', 'Rua Dona Elvira', 'Encruzilhada', '999', '', '9999-999', 'PE', 'Recife', 'josenaldo', '123'),
	(5, 'Motorista', 'Desabilitado', '', '', '', '', 'Marcello', '999.999.999-99', '999.999-9', 'sds/pe', 'teste@gmail.com', '(81) 9999-9999', '(81) 9999-9999', 'Rua Dona Elvira', 'Encruzilhada', '999', '', '9999-999', 'PE', 'Recife', 'marcello', '123'),
	(6, 'Motorista', 'Habilitado', '', '', '', '', 'Marcos', '999.999.999-99', '999.999-9', 'sds/pe', 'teste@gmail.com', '(81) 9999-9999', '(81) 9999-9999', 'Rua Dona Elvira', 'Encruzilhada', '999', '', '9999-999', 'PE', 'Recife', 'marcos', '123'),
	(7, 'Atendente', 'Habilitado', '', '', '', '', 'Anderson', '999.999.999-99', '999.999-9', 'sds/pe', 'teste@gmail.com', '(81) 9999-9999', '(81) 9999-9999', 'Rua Dona Elvira', 'Encruzilhada', '999', '', '9999-999', 'PE', 'Recife', 'anderson', '123'),
	(8, 'Pessoa Fisica', 'Habilitado', '', '', '', '', 'Pena Forte', '999.999.999-99', '999.999-9', 'sds/pe', 'teste@gmail.com', '(81) 9999-9999', '(81) 9999-9999', 'Rua Dona Elvira', 'Encruzilhada', '999', '', '9999-999', 'PE', 'Recife', 'penaforte', '123'),
	(9, 'Pessoa Juridica', 'Habilitado', '', '', '', '', 'Flavius', '999.999.999-99', '999.999-9', 'sds/pe', 'teste@gmail.com', '(81) 9999-9999', '(81) 9999-9999', 'Rua Dona Elvira', 'Encruzilhada', '999', '', '9999-999', 'PE', 'Recife', 'flavius', '123');
...
REPLACE INTO `veiculos` (`id`, `placa`, `capacidadeKg`, `capacidadeM3`, `ano`, `tipo`, `uf`, `cidade`) VALUES
	(1, 'AAA-9999', 0, 0, '2015', '', 'PE', 'Recife');
