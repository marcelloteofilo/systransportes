...
-- Copiando dados para a tabela systransportes.cotacoes: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela systransportes.usuarioperfil: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarioperfil` DISABLE KEYS */;
REPLACE INTO `usuarioperfil` (`id`, `descricao`) VALUES
	(1, 'PF'),
	(2, 'PJ'),
	(3, 'Atendente'),
	(4, 'Motorista');
...
REPLACE INTO `usuarios` (`id`, `idPerfil`, `idStatus`, `codCidade`, `nomeCompleto`, `razaoSocial`, `nomeFantasia`, `tipoEmpresa`, `rg`, `orgaoExpedidor`, `cpf`, `cnpj`, `email`, `telefone1`, `telefone2`, `logradouro`, `bairro`, `numero`, `complemento`, `cep`, `login`, `senha`) VALUES
	(1, 1, 1, 2611606, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'MASTER', '123');
...
-- Copiando dados para a tabela systransportes.usuariostatus: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `usuariostatus` DISABLE KEYS */;
REPLACE INTO `usuariostatus` (`id`, `descricao`) VALUES
	(1, 'Habilitato'),
	(2, 'Desabilitado');
...
-- Copiando dados para a tabela systransportes.veiculos: ~3 rows (aproximadamente)
