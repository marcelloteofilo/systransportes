...
-- Copiando dados para a tabela systransportes.cargas: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela systransportes.frete: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela systransportes.mercadorias: ~3 rows (aproximadamente)
...
REPLACE INTO `usuarios` (`id`, `perfil`, `status`, `razaoSocial`, `nomeFantasia`, `tipoEmpresa`, `cnpj`, `nomeCompleto`, `cpf`, `rg`, `orgaoExpedidor`, `email`, `telefone1`, `telefone2`, `logradouro`, `bairro`, `numero`, `complemento`, `cep`, `estado`, `cidade`, `login`, `senha`) VALUES
	...
	(5, 'Motorista', 'Habilitado', '', '', '', '', 'Marcello', '999.999.999-99', '999.999-9', 'sds/pe', 'teste@gmail.com', '(81) 9999-9999', '(81) 9999-9999', 'Rua Dona Elvira', 'Encruzilhada', '999', '', '9999-999', 'PE', 'Recife', 'marcello', '123'),
