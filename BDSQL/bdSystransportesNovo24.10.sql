...
REPLACE INTO `cargas` (`codCarga`, `codUsuario`, `origem`, `destino`, `altura`, `largura`, `peso`, `comprimento`, `quantidade`, `valor`, `telefone`, `logradouro`, `bairro`, `uf`, `cidade`, `numero`, `observacao`, `naturezaCarga`, `dataPedido`, `distancia`, `prazo`, `frete`, `coletada`, `statusCarga`) VALUES
	(1, 1, 1099910, 1099910, 444, 444, 44, 444, 4433, 3333, '(81)3243-3206', 'Rua Dona Elvira', 'Encruzilhada', 'PE', 'Recife', '280', 'é uma casa comum', 'Tipo 1', '24/10/2015', 400, '4', 45, 'Aguardando', '');
...
-- Copiando dados para a tabela systransportes.status_frete: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela systransportes.status_situacao: ~2 rows (aproximadamente)
