...
REPLACE INTO `cargas` (`codCarga`, `codUsuario`, `origem`, `destino`, `altura`, `largura`, `peso`, `comprimento`, `quantidade`, `valor`, `telefone`, `logradouro`, `bairro`, `uf`, `cidade`, `numero`, `observacao`, `naturezaCarga`, `dataPedido`, `distancia`, `prazo`, `frete`, `coletada`, `statusCarga`) VALUES
	(1, 1, 1099910, 1700350, 444, 444, 44, 444, 4433, 3333, '(81)3243-3206', 'Rua Dona Elvira', 'Encruzilhada', 'PE', 'Recife', '280', 'casa comum', 'Tipo 1', '24/10/2015', 33, '20', 200, '', 'Aprovado Atendente'),
	(4, 1, 1099910, 1700350, 444, 444, 44, 444, 4433, 3333, '(81)3243-3206', 'Rua Dona Elvira', 'Encruzilhada', 'PE', 'Recife', '280', 'casa comum', 'Tipo 1', '24/10/2015', 33, '20', 200, 'Coletado', 'Aprovado Cliente'),
	(5, 1, 1099910, 1700350, 444, 444, 44, 444, 4433, 3333, '(81)3243-3206', 'Rua Dona Elvira', 'Encruzilhada', 'PE', 'Recife', '280', 'casa comum', 'Tipo 1', '24/10/2015', 33, '20', 200, '', 'Atendimento'),
	(6, 1, 1099910, 1700350, 444, 444, 44, 444, 4433, 3333, '(81)3243-3206', 'Rua Dona Elvira', 'Encruzilhada', 'PE', 'Recife', '280', 'casa comum', 'Tipo 1', '24/10/2015', 33, '20', 200, 'Aprovado', 'Aprovado Cliente');
...
REPLACE INTO `frete` (`codFrete`, `codVeiculo`, `codMotorista`, `origem`, `destino`, `statusFrete`, `codTransp`) VALUES
	(1, 1, 2, 2611606, 1701002, 'Despachada', '123456');
...
REPLACE INTO `usuarios` (`id`, `perfil`, `status`, `razaoSocial`, `nomeFantasia`, `tipoEmpresa`, `cnpj`, `nomeCompleto`, `cpf`, `rg`, `orgaoExpedidor`, `email`, `telefone1`, `telefone2`, `logradouro`, `bairro`, `numero`, `complemento`, `cep`, `estado`, `cidade`, `login`, `senha`) VALUES
	...
	(4, 'Motorista', 'Habilitado', '', '', '', '', 'MOTORISTA', '999.999.999-99', '999.999-9', 'sdspe', 'test@teste.com.br', '12345', '54321', 'teste1', 'teste2', '1233', 'teste3', '123456789', 'PE', 'Recife', 'MOTORISTA', '123456');
