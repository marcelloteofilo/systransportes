...
CREATE TABLE IF NOT EXISTS `cargas` (
  ...
  `cotado` varchar(50) DEFAULT NULL,
...
-- Copiando dados para a tabela systransportes.cargas: ~4 rows (aproximadamente)
...
REPLACE INTO `cargas` (`codCarga`, `codUsuario`, `origem`, `destino`, `altura`, `largura`, `peso`, `comprimento`, `quantidade`, `valor`, `telefone`, `logradouro`, `bairro`, `uf`, `cidade`, `numero`, `observacao`, `naturezaCarga`, `dataPedido`, `distancia`, `prazo`, `frete`, `coletada`, `cotado`, `statusCarga`) VALUES
	(1, 1, 1099910, 1700350, 444, 444, 44, 444, 4433, 3333, '(81)3243-3206', 'Rua Dona Elvira', 'Encruzilhada', 'PE', 'Recife', '280', 'casa comum', 'Tipo 1', '24/10/2015', 33, '20', 5000, '', 'Nao Cotado', ''),
	(4, 1, 1099910, 1700350, 444, 444, 44, 444, 4433, 3333, '(81)3243-3206', 'Rua Dona Elvira', 'Encruzilhada', 'PE', 'Recife', '280', 'casa comum', 'Tipo 1', '24/10/2015', 33, '20', 300, 'Coletado', 'Cotado', 'Aprovado'),
	(5, 1, 1099910, 1700350, 444, 444, 44, 444, 4433, 3333, '(81)3243-3206', 'Rua Dona Elvira', 'Encruzilhada', 'PE', 'Recife', '280', 'casa comum', 'Tipo 1', '24/10/2015', 33, '20', 200, '', 'Cotado', 'Nao Aprovado'),
	(6, 1, 1099910, 1700350, 444, 444, 44, 444, 4433, 3333, '(81)3243-3206', 'Rua Dona Elvira', 'Encruzilhada', 'PE', 'Recife', '280', 'casa comum', 'Tipo 1', '24/10/2015', 33, '20', 100, 'Coletado', 'Cotado', 'Aprovado'),
	(7, 1, 1099910, 1700350, 444, 444, 44, 444, 4433, 3333, '(81)3243-3206', 'Rua Dona Elvira', 'Encruzilhada', 'PE', 'Recife', '280', 'casa comum', 'Tipo 1', '24/10/2015', 33, '20', 500, 'Coletado', 'Cotado', 'Aprovado');
...
-- Copiando dados para a tabela systransportes.ctes: ~7 rows (aproximadamente)
/*!40000 ALTER TABLE `ctes` DISABLE KEYS */;
REPLACE INTO `ctes` (`numcte`, `codCarga`, `codFrete`, `situacao`, `chaveAcesso`, `statuscte`, `emissao`) VALUES
...
-- Copiando dados para a tabela systransportes.frete: ~6 rows (aproximadamente)
...
REPLACE INTO `frete` (`codFrete`, `codVeiculo`, `codMotorista`, `ufOrigem`, `cidadeOrigem`, `ufDestino`, `cidadeDestino`, `statusFrete`, `codTransp`) VALUES
	(1, 1, 2, 'CE', 'Floresta', 'PE', 'Sobral', '', '123456'),
	(2, 1, 2, '$ufOrigem', '$cidadeOrigem', '$ufDestino', '$cidadeDestino', '$statusFrete', '$codTransp'),
	(3, 1, 2, '$ufOrigem', '$cidadeOrigem', '$ufDestino', '$cidadeDestino', '$statusFrete', '$codTransp'),
	(4, 1, 2, '$ufOrigem', '$cidadeOrigem', '$ufDestino', '$cidadeDestino', '$statusFrete', '$codTransp'),
	(5, 1, 2, '$ufOrigem', '$cidadeOrigem', '$ufDestino', '$cidadeDestino', '$statusFrete', '$codTransp'),
	(6, 1, 2, '$ufOrigem', '$cidadeOrigem', '$ufDestino', '$cidadeDestino', '$statusFrete', '$codTransp'),
	(7, 1, 2, 'PE', 'recife', 'CE', 'sobral', 'Aguardando', '1234');
...
-- Copiando dados para a tabela systransportes.usuarios: ~2 rows (aproximadamente)
...
REPLACE INTO `usuarios` (`id`, `perfil`, `status`, `razaoSocial`, `nomeFantasia`, `tipoEmpresa`, `cnpj`, `nomeCompleto`, `cpf`, `rg`, `orgaoExpedidor`, `email`, `telefone1`, `telefone2`, `logradouro`, `bairro`, `numero`, `complemento`, `cep`, `estado`, `cidade`, `login`, `senha`) VALUES
	(1, 'Pessoa Fisica', 'Habilitado', NULL, NULL, NULL, NULL, 'ADMIN', '999.999.999-99', '999.999-9', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'MASTER', '123'),
	(2, 'Motorista', 'Habilitado', '', '', '', '', 'testet', '999.999.999-99', '999.999-9', '', '', '', '', '', '', '', '', '', '', '', 'MOTORISTA', '123456'),
	(4, 'Motorista', 'Habilitado', '', '', '', '', 'Marcello Teofilo', '999.999.999-99', '999.999-9', 'sdspe', 'test@teste.com.br', '12345', '54321', 'teste1', 'teste2', '1233', 'teste3', '123456789', 'PE', 'Recife', 'marcello', '321');
