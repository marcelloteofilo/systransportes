...
--
-- Host: localhost
-- Generation Time: 24-Out-2015 às 16:36
...
--
-- Estrutura da tabela `status_frete`
--

CREATE TABLE IF NOT EXISTS `status_frete` (
  `codStatusFrete` int(11) NOT NULL,
  `status` varchar(50) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `status_frete`
--

INSERT INTO `status_frete` (`codStatusFrete`, `status`) VALUES
(1, 'Aguardando'),
(2, 'Iniciada'),
(3, 'Finalizada');
...
--
-- Estrutura da tabela `status_situacao`
--

CREATE TABLE IF NOT EXISTS `status_situacao` (
  `codStatusSituacao` int(11) NOT NULL,
  `status` varchar(50) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `status_situacao`
--

INSERT INTO `status_situacao` (`codStatusSituacao`, `status`) VALUES
(1, 'Despachada'),
(2, 'Em Transito'),
(3, 'Entrege');
...
(2, 'Atendente', 'Habilitado', '', '', '', '', 'Maria', '088.673.464-90', '', '', 'maria@gmail.com', '', '', '', '', '', '', '', '', '', 'maria', '12');
...
ALTER TABLE `ctes`
  ...
  ADD KEY `FK_ctes_manifestos` (`codRota`),
  ADD KEY `FK_ctes_status_situacao` (`situacao`);
...
ALTER TABLE `frete`
  ...
  ADD KEY `FK_manifestos_veiculos` (`codVeiculo`),
  ADD KEY `FK_manifestos_usuarios` (`codMotorista`),
  ADD KEY `FK_manifestos_cidades` (`origem`),
  ADD KEY `FK_manifestos_cidades_2` (`destino`),
  ADD KEY `FK_frete_status_frete` (`statusFrete`);
...
ALTER TABLE `rastreamentos`
  ...
  ADD KEY `FK_rastreamentos_manifestos` (`codRota`);

--
-- Indexes for table `status_frete`
--
ALTER TABLE `status_frete`
  ADD PRIMARY KEY (`codStatusFrete`);

--
-- Indexes for table `status_situacao`
--
ALTER TABLE `status_situacao`
  ADD PRIMARY KEY (`codStatusSituacao`);
...
--
ALTER TABLE `cargas`
  MODIFY `codCarga` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `frete`
  MODIFY `codFrete` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `rastreamentos`
  MODIFY `codRastreamento` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `status_frete`
--
ALTER TABLE `status_frete`
  MODIFY `codStatusFrete` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `status_situacao`
--
ALTER TABLE `status_situacao`
  MODIFY `codStatusSituacao` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
ALTER TABLE `ctes`
  ...
  ADD CONSTRAINT `FK_ctes_manifestos` FOREIGN KEY (`codRota`) REFERENCES `frete` (`codFrete`),
  ADD CONSTRAINT `FK_ctes_status_situacao` FOREIGN KEY (`situacao`) REFERENCES `status_situacao` (`codStatusSituacao`);

--
-- Limitadores para a tabela `frete`
--
ALTER TABLE `frete`
  ADD CONSTRAINT `FK_frete_status_frete` FOREIGN KEY (`statusFrete`) REFERENCES `status_frete` (`codStatusFrete`),
  ADD CONSTRAINT `FK_manifestos_cidades` FOREIGN KEY (`origem`) REFERENCES `cidades` (`codigo`),
  ADD CONSTRAINT `FK_manifestos_cidades_2` FOREIGN KEY (`destino`) REFERENCES `cidades` (`codigo`),
  ADD CONSTRAINT `FK_manifestos_usuarios` FOREIGN KEY (`codMotorista`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `FK_manifestos_veiculos` FOREIGN KEY (`codVeiculo`) REFERENCES `veiculos` (`id`);
...
--
-- Limitadores para a tabela `rastreamentos`
--
ALTER TABLE `rastreamentos`
  ADD CONSTRAINT `FK_rastreamentos_manifestos` FOREIGN KEY (`codRota`) REFERENCES `frete` (`codFrete`);
