$(document).ready(function ()
{
    $('.add').click(function ()
    {
        ...
        $('#tabelaItens > tbody').append('<tr>\n\n\n\
                    ...
                    <td><input class="form-control" type="text" id="' + quantidade + '" name="quantidade[]" value="" size="10" placeholder="0,00" maxlength="8" ></td>\n\n\
                    <td><input class="form-control" type="text" id="' + pesoMercadoria + '" name="pesoMercadoria[]" value="" size="4" placeholder="0,00" maxlength="8"></td>\n\n\
                    <td><input class="form-control" type="text" id="' + valor + '" name="valor[]" value="" size="4" placeholder="0,00" maxlength="8"></td>\n\n\
                    <td>&nbsp;</td>\n</tr>\n');
