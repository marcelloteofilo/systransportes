    ...
    <div id="dlg" class="easyui-dialog" style="background:#F3F8F7; width:1200px;height:600px;padding:10px 20px"
        ...
        <form id="fm" method="post" novalidate>
            ...
            <table width="100%">
                ...
                <tr>
                    <td><input readonly  type="text" id="telefone" name="telefone" class="form-control" placeholder="(00)0000-0000" tabindex="1" onkeydown="teclasNumeros()" ></td>
                    <td><input readonly  type="text" id="logradouro" name="logradouro" class="form-control" placeholder="Logradouro" tabindex="1" onkeydown="teclasLetrasNumeros()" ></td>
                    <td><input readonly  type="text" id="bairro" name="bairro" class="form-control" placeholder="Bairro" tabindex="1" onkeydown="teclasLetrasNumeros()" ></td>
                    <td><input readonly  type="text" id="numero" name="numero" class="form-control" placeholder="Número" tabindex="1" onkeydown="teclasLetrasNumeros()" ></td>
                    <td><input readonly  type="text" id="uf" name="uf" class="form-control" placeholder="UF" tabindex="1" ></td>
                    <td><input readonly  type="text" id="cidade" name="cidade" class="form-control" placeholder="Cidade" tabindex="1" onkeydown="teclasLetrasNumeros()" ></td>
                </tr>
            </table>
            <table width="100%">
                <tr>
