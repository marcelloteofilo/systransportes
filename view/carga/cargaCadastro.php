                            ...
                            <div class="container">
                                <form  method="post" id="frmCotacao" name="frmCotacao" action="cargaWebService.php?editSave=incluir">
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <select class="form-control" id="cidadeOrigem" name="cidadeOrigem"  onChange="juntaCidadeUf();
                                                        CalculaDistancia();">
                                                    <option  value="">Escolha Cidade Origem</option>
                                                </select>
                                            </td>
                                            <td>
                                                <select class="form-control" id="cidadeDestino" name="cidadeDestino"  onChange="juntaCidadeUf();
                                                        CalculaDistancia();">
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td><input type="text" id="telefone" name="telefone" class="form-control" placeholder="(00)0000-0000" tabindex="1" onkeydown="teclasNumeros()" ></td>
                                            <td><input type="text" id="logradouro" name="logradouro" class="form-control" placeholder="Logradouro" tabindex="1"  onkeydown="teclasLetrasNumeros()"></td>
                                            <td><input type="text" id="bairro" name="bairro" class="form-control" placeholder="Bairro" tabindex="1" onkeydown="teclasLetrasNumeros()" ></td>
                                            <td><input type="text" id="numero" name="numero" class="form-control" placeholder="Número" tabindex="1" onkeydown="teclasLetrasNumeros()" ></td>
                                            <td>
                                            ...
                                            <td><input type="text" id="cidade" name="cidade" class="form-control" placeholder="Cidade" tabindex="1"onkeydown="teclasLetrasNumeros()" ></td>
                                        </tr>
                                    </table>
                                    <table width="100%">
                                        <tr>
                                    ...
                                    <table width="100%" id="tabelaItens">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input class="form-control"type="text" name="descricaoMercadoria[]" id="descricaoMercadoria" value="" size="90" placeholder="Descrição sobre a mercadoria" maxlength="50"
                                                           onkeydown="teclasLetrasNumeros()"/></td>
                                                <td><input class="form-control"type="text" name="quantidadeMercadoria[]" id="quantidadeMercadoria" value="" size="10" placeholder="0,00" maxlength="8" onkeydown="teclasNumeros()"/></td>
                                                <td><input class="form-control"type="text" name="pesoMercadoria[]" id="pesoMercadoria" value="" size="4" placeholder="0,00" maxlength="8" onkeydown="teclasNumeros()"/></td>
                                                <td><input class="form-control"	type="text" name="valorMercadoria[]" id="valorMercadoria" value="" size="4" placeholder="0,00" maxlength="8" onkeydown="teclasNumeros()" /></td>
                                                <td>&nbsp;</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td><input type="text" id="altura" name="altura" class="form-control" placeholder="0,00" tabindex="1" onKeyPress="return(MascaraMoeda(this, '.', ',', event))" onkeydown="teclasNumeros()"></td>
                                            <td><input type="text" id="largura" name="largura" class="form-control" maxlength="14" placeholder="0,00" tabindex="1" onKeyPress="return(MascaraMoeda(this, '.', ',', event))" onkeydown="teclasNumeros()"></td>
                                            <td><input type="text" id="peso" name="peso" class="form-control" maxlength="9" placeholder="0,00" tabindex="1" onKeyPress="return(MascaraMoeda(this, '.', ',', event))" onkeydown="teclasNumeros()"></td>
                                            <td><input type="text" id="comprimento" name="comprimento" maxlength="8" class="form-control" placeholder="0,00" tabindex="1" onKeyPress="return(MascaraMoeda(this, '.', ',', event))" onkeydown="teclasNumeros()"></td>
                                            <td><input type="text" id="quantidade" name="quantidade" class="form-control" maxlength="9" placeholder="0,00" tabindex="1" onKeyPress="return(mascaraInteiro())" onkeydown="teclasNumeros()"></td>
                                            <td><input type="text" id="valor" name="valor" maxlength="8" class="form-control" placeholder="0,00" tabindex="1" onKeyPress="return(MascaraMoeda(this, '.', ',', event))"  onBlur="focus_Blur(this, 'white');
                                                    CalculaDistancia();"></td>
                                        </tr>
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="hidden" name="idUsuario" id="idUsuario" value="<?php
                                                    if($objusuario)
                                                    {
