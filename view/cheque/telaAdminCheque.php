...
<html lang="en" class="no-js">
      ...
      <script type="text/javascript">
         $(function(){
             ...
             $('#dg').edatagrid({
                 ...
                 saveUrl: '../../webServices/chequeWebService.php?editSave=incluirCheque',
                 updateUrl: '../../webServices/chequeWebService.php?editSave=alterarCheque',
                 destroyUrl: '../../webServices/chequeWebService.php?editSave=deletarCheque',
                 fitColumns: true
   ...
   <body style="background:#F3F8F7">
      ...
      <center>
         <table id="dg" title="Cadastro de Cheques" style="width:1250px;height:450px; border:1px solid #ccc;"
            toolbar="#toolbar" pagination="true" idField="id"
            rownumbers="true" fitColumns="true" resizable="true">
            <thead>
               <tr>
                  <th field="parcela" width="50" editor="{type:'validatebox',options:{required:true}}">Parcela</th>
                  <th field="numero" width="70" editor="{type:'validatebox',options:{required:true}}">Número</th>
                  <th field="valor" width="50" editor="{type:'validatebox',options:{required:true}}">Valor</th>
                  <th field="vencimento" width="50" editor="{type:'validatebox',options:{required:true}}">Vencimento</th>
               </tr>
            </thead>
         </table>
         <div id="toolbar">
            <a href="#" class="easyui-linkbutton" iconCls="icon-users-add-icon" plain="true" onclick="javascript:$('#dg').edatagrid('addRow')">Criar Cheque</a>
