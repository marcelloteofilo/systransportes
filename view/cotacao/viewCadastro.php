...
require_once '../../modelo/cotacao/cotacaoSql.php';
    ...
    if (isset($_POST['cadastrar'])) {
        ...
        for ($i = 0; $i < count($valores); $i++) {
            $idCotacao = 14;//CotacaoSql::ultimo();
                                                        ...
                                                        <table width="50%" id="tabelaItens">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="descricao[]" id="descricao" value="" size="60" /></td>
                                                                    <td><input type="text" name="peso[]" id="peso" value="" size="4" /></td>
                                                                    <td>&nbsp;</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <tr style="border: 1px solid;">	
                                                            ...
                                                            <td>								
                                                                <input type="text" size="7" tabindex="9" type="text" onfocus="focus_Blur(this, 'yellow');"onblur="focus_Blur(this, 'white');
                                                                        CalculaDistancia();" value="" id="peso" name="peso"  onKeyPress="return(MascaraMoeda(this, '.', ',', event))">
                                                            </td>					
                                                            <td >													
