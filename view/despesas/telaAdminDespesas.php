...
<center>
    ...
    <div id="toolbar">
        <a href="#" class="easyui-linkbutton" iconCls="icon-Money-icon" plain="true" onclick="newDespesas()" title="Adicionar Despesa">Novo Despesa</a>
        <a href="#" class="easyui-linkbutton" iconCls="icon-save-as-icon" plain="true" onclick="editDespesas()" title="Alterar Dados do Despesa">Editar Despesa</a>
        <a href="#" class="easyui-linkbutton" iconCls="icon-delete-icon" plain="true" onclick="removeDespesas()" title="Remover Dados do Despesa">Remover Despesa</a>
...
<div id="dlg-buttons">
    <a href="#" class="easyui-linkbutton" iconCls="icon-App-clean-icon" onclick="saveDespesas()">Salvar</a>
