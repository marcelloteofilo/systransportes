...
<html lang="en" class="no-js">
   ...
   <body id="body">
      ...
      <!-- Features -->
      <section id="cadastropf" class="features">
         <div class="container">
            <div class="row">
                  ...
                  <nav class="navbar">
                     ...
                     <div class="container">
                        <form>
                           ...
                           <br>
                           <input class="btn btn-success btn-login-submit" value="Confirmar" type="submit" id="btnIncluir" onClick="consultaAJAXPF()">
