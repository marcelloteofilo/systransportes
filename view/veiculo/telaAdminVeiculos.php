    ...
    <form id="fm" method="post" novalidate>
        ...
        <table>
            ...
            <tr>
                ...
                <td><input required="required" class="form-control" type="text" id="capacidadeKg" name="capacidadeKg" size="23" style="text-transform:uppercase"  placeholder="Cap. Quilogramas" value="0,00" onKeyPress="return(MascaraMoeda(this, '.', ',', event));
                        validar(this, 'num');"></td>
                <td><input required="required" class="form-control" type="text" id="capacidadeM3" name="capacidadeM3" size="23" style="text-transform:uppercase"  placeholder="Cap. Metros³" value="0,00" onKeyPress="return(MascaraMoeda(this, '.', ',', event));
                        validar(this, 'num');"></td>
